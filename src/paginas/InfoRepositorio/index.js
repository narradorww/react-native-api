...
import { salvarRepositorioDoUsuarios, deletarRepositorioDoUsuarios } from '../../servicos/requisicoes/repositorios';
...
export default function InfoRepositorio({ route, navigation }) {
    ...
    async function apagar(){
        const resultado = await deletarRepositorioDoUsuarios(route.params.item.id);
        if(resultado==='sucesso'){
            Alert.alert('Sucesso', 'Repositório deletado com sucesso');
            navigation.goBack();
        } else {
            Alert.alert('Erro', 'Erro ao deletar repositório');
        }
    }
